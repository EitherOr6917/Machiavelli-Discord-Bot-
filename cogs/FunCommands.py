...
class FunCommands(commands.Cog):
    ...
    async def cards_against_humanity_rules(self, ctx):
        if not is_banned(ctx) and not channel_banned(ctx):
            await ctx.author.send('To start the game, each player draws ten white cards. The player who most '
                                  'recently pooped begins as the Card Czar and draws a black card. If Hugh '
                                  'Jackman is playing, he goes first, regardless of how recently he pooped. The '
                                  ...
                                  'white card, face down, to the Card Czar. The Card Czar then shuffles all the '
                                  ...
                                  'point. After the round, a new player becomes the Card Czar and everyone draws '
